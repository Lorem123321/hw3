...
## *git clone*
>Команда git clone скопировать себе содержание репозитория и работать с ним локально

## *git remote add origin*
> Команда git remote add origin позволяет создать привязку к удаленному репозиторию

## *git branch -M <ветка>*
>Команда git branch позволяет cделать <ветка> основной веткой

## *git push -u origin <ветка>*
>Команда git push -u origin позволяет токнуть ветку на сервер

## *git pull*
>Команда git pull позволяет скачать и сделать merge изменений с локальной веткой
